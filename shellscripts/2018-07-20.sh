...
python ../experiments/exp_continuous_mountain_car.py --root-dir ../data5 --seed ${i} --entropy-coeff 0.0 --n-epochs 1000 --dynamic-coeff False &
sleep 1
python ../experiments/exp_continuous_mountain_car.py --root-dir ../data5 --seed ${i} --entropy-coeff 1.0 --n-epochs 1000 --dynamic-coeff True  &
sleep 1
