...
#legends="DefaultExploration^EExploitation0.3^EExploitation0.35^EExploitation0.4^KnackExploration^SignedVariance^NegativeSignedVariance^SmallVariance^kurto-signed_var^kurto-negative_signed_var^kurto-var"
...
#legends="Default^Knack^SmallVariance^NegativeSignedVar^kurto-signed_var^kurto-negative_signed_var^kurto-smallvar"
#mode="exploitation"
...
#legends="Default^kurtosis^small_variance^signed_variance^large_variance^EExploitation"
...
echo "--root-dirs ${dirs} --legends ${legends} --mode ${mode} --smooth 2"
python ../../misc/plotter/return_plotter.py --root-dirs ${dirs} --legends ${legends} --xlabel total_step --ylabel ${ylabel} --smooth 50 --plot_mode raw
