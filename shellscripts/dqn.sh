...
#  LOGDIR1="/tmp/dqn_test2/seed${seed}"
  ...
  # proposed method
#  LOGDIR1="/mnt/ISINAS1/karino/SubgoalGeneration/ExploitationRatioThreshold/DQNnew/samelogging${total_timesteps}_feps${feps}_frac${frac}/${policy_mode}${bottleneck_threshold_ratio}/${env_id}/seed${seed}"
