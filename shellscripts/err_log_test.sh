...
#  LOGDIR1="/mnt/ISINAS1/karino/SubgoalGeneration/ParameterSearch/${policy_mode}/${env}/seed${seed}"  # GMMPolicy
  CMD="python ../experiments/gym_experiment.py --env-id ${env} --policy-mode ${policy_mode} --root-dir ${LOGDIR1} --seed ${seed} --entropy-coeff 0.0 --n-epochs 2000 --normalize-obs 0 --eval_n_episodes ${eval_num} --eval_n_frequency 1 --save_array_flag ${savearray} --e ${e}"
